...
INSERT INTO `e_house` (`h_id`, `h_name`, `h_address`, `h_postal_code`, `h_city`, `h_country`, `h_value`) VALUES
(1, NULL, '10880, Malibu Point', 90265, 'Malibu', 'US', 150895000),
(2, 'Wayne Manor', 'Crest Hill', 333, 'Gotham City', 'US', 228733000);
